...
//Convenience functions for generating a new AS3 class instance of b2WheelJoint
FREResult FRENewObjectFromb2WheelJoint(b2WheelJoint* obj, FREObject as3Object) {
	...
	const uint8_t* className = (const uint8_t*)"ca.digitalarchitect.box2dane.dynamics.joints.b2WheelJoint";

	FREResult objInitResult = FRENewObject(className, 1, constructorArguments, &as3Object, &initException);

	if(objInitResult != FRE_OK) {
		FREError("Error creating b2WheelJoint object in function FRENewObjectFromb2WheelJoint");
	}

	return objInitResult;
}

FREResult FRENewb2WheelJoint(FREObject as3Object) {
	...
	if(objInitResult != FRE_OK) {
		FREError("Error creating b2WheelJoint object in function FRENewb2WheelJoint");
	}
